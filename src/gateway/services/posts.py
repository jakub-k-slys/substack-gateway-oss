...
class PostsService:
    ...
    async def get_posts_for_profile(
        ...
        r = await self._sub._request(
            "GET", f"{self._sub._base}/profile/posts", params=params
        )
    ...
    async def get_notes_for_profile(
        ...
        r = await self._pub._request(
            "GET",
            f"{self._pub._base}/reader/feed/profile/{profile_id}",
            params=params,
        )
    ...
    async def get_post_by_id(self, post_id: int) -> SubstackFullPost:
        ...
        r = await self._sub._request("GET", f"{self._sub._base}/posts/by-id/{post_id}")
    ...
    async def get_comments_for_post(self, post_id: int) -> list[SubstackComment]:
        ...
        r = await self._pub._request(
            "GET", f"{self._pub._base}/post/{post_id}/comments"
        )
