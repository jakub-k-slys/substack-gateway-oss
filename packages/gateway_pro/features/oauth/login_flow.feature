Feature: OAuth login flow
  ...
  So that I can authorize gateway access via OAuth
  ...
  # ------------------------------------------------------------------
  # Phase 2 — authorization confirmation
  # ------------------------------------------------------------------

  Scenario: Authorization confirmation shows success page
  ...
  Scenario: Missing session shows error
    Given I have completed phase 1 login with "user@example.com" and "secret123"
  ...
  Scenario: Auth code is created after authorization
    Given I have completed phase 1 login with "user@example.com" and "secret123"
    When I submit the authorization form
